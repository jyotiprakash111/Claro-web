...
import useBusinessSignup from "@hooks/auth/useBusinessSignup";
import { Alert } from "@material-ui/lab";
import { useAuth } from "@contexts/Auth";
import Button from "@components/button";
import GoogleIcon from "@assets/icons/google.svg";
import CustomerSignupLink from "./customerSignup";
...
export default function BusinessSignup() {
	...
	const { mutate, isLoading, isError, error } = useBusinessSignup();
		...
		<div style={{ background: "#f2f2f7" }}>
			...
			>
				<Box>
					...
					<Box mt={2} mb={8} style={{ marginTop: "30px" }}>
						<Typography variant="body1" align="center">
							<h2>Already have an account?</h2>
							<Link to="/businessLogin">Log In</Link>
						</Typography>
					</Box>
				</Box>
			</Box>
